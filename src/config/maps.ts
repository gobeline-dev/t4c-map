...
export const MAPS: MapInfo[] = [
  ...
  { id: 'ravendust',  worldId: 3, name: 'Drake Island',                      path: `${BASE}assets/maps/map_HD_3_RavenDust.png` },
  { id: 'stoneheim',  worldId: 4, name: 'Ile de Lune - Nieve',               path: `${BASE}assets/maps/map_HD_4_Stoneheim.png` },
